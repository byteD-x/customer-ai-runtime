...
10. 面试 demo 冒烟：输出 route、citations、finance_knowledge、saas_knowledge、tool_result、handoff_package、handoff_queue、claimed_session、cost_summary、rag_eval_summary
